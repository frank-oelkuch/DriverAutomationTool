...
.NOTES
    ...
    Version history:
	5.0.0  - (2017-06-09)	Redesigned user interface. 
							ConfigMgr - Added pilot option for new packages. 
									Added driver state management for production, pilot & retirement
									You can move packages between each state within the tool
							MDT - 	Added ability to specify alternative MDT PS module location
									Added ability to select one or mode MDT deployment shares
	5.0.1 - (2017-10-20)	Additional tab and import function to allow for adding unsupported
							Makes & Models into ConfigMgr and MDT. ConfigMgr packages can be used	
							with the MDM solution for dynamic deployment.
							Minor fixes & added support for Windows 10 1709 
	5.0.2 - (2017-10-27)	Added option to opt in or opt out of WMI model imports when using the tool with
							Dell & Lenovo hardware and ConfigMgr. 
							Added additional verbose output and exception catches
							Added boot image check on driver removal
	5.0.3 - (2017-11-01)    Updated source location for HP BIOS downloads
							Added Driver Fallback Package options 
	5.0.4 - (2017-11-02)	Code performance improvements
							Microsoft Surface download fixes
	5.0.5 - (2017-11-07)	Driver Fallback architecture update
	5.0.6 - (2017-11-09)	Fix for Lenovo driver package creation where the destination directory and contents
							already exist from a deleted package
							Added pre-req check for the package directory
	5.0.7 - (2017-11-10)	Added sleep commands for binary dif replication and distribution to allow for slow
							package creation.
	5.0.8 - (2017-11-17)	Added WMI known models for HP
							Added additional check for known models so they now display only where the OS selected		
							is supported.
	5.0.9 - (2017-11-29)	Fixed issue with moving packages between deployment states
							Added fix for Lenovo file security warnings
	5.1.0 - (2017-12-14)	Fixed issue with scheduled task button not running function
	5.1.1 - (2017-12-22)	Added MDM/MBM diagnostics tab for testing connectivity to the ConfigMgr WebService
	5.1.2 - (2017-12-29) 	Changed existing package method detection for standard and driver packages
							Typo corrected
	5.1.3 - (2018-01-05)	Updated method for determining web service build
							Fixes for Lenovo driver package matching and superseded package removal
	5.1.4 - (2018-01-08)	Lenovo Update - Important: Package name will no longer include the SKU value in the 
							package name. 
							Processing updates and minor tweaks. 
	5.1.5 - (2018-01-13)	Updates to the code that deals with BIOS downloads
							Updates to the HP BIOS download parsing code due to XML formatting changes
	5.1.6 - (2018-01-16)	Update for Lenovo Windows 8.1 driver matches
	5.1.7 - (2018-01-18)	Fix for Lenovo BIOS package storage locations resulting in empty packages
	5.1.8 - (2018-01-25)	Code changes and fix for MDT import process
	5.2.0 - (2018-02-09)	Code changes and optimisation throughout the script
	...
	5.2.1 - (2018-02-19)	Updated Dell multiple model package matching
	...
	6.1.0 - (2018-08-21)	Updated GUI. Model list can now be expanded
	...
	6.1.1 - (2018-09-06) 	Fix for Lenovo file downloads
							Fix for custom package creation for ConfigMgr & MDT
							Minor GUI related fix for custom packages tab
#>
...
"@ -IgnoreWarnings | Out-Null
	...
	$ReleaseNotesLabel = New-Object 'System.Windows.Forms.Label'
	...
	$MainForm_Load = {
		...
		if ($global:RunSilent -eq "True") {
			...
			# 2018-09-07 (oelkufr): Commented the Invoke-WebRequest for release notes as it does not work behind a proxy / is run before proxy credentials can be specified
			...
			# 2018-09-07 (oelkufr): Changed behaviour to not try to load from internet before proxy credentials can be specified
            # UpdateModeList $SiteServerInput.Text $SiteCodeText.Text
            # $ModelResults.Text = "Found ($($MakeModelDataGrid.Rows.Count)) matches"
            $ModelResults.Text = "Please click [Find Models] to populate the list"
		}
	...
	$StartDownloadButton_Click = {
		...
		if ($UseProxyServerCheckbox.Checked -eq $true) {
            # 2018-09-07 (oelkufr): Changed to use a fixed URL as $URL appeared to be NULL/empty
	...
	$OSComboBox_SelectedIndexChanged = {
		...
		if ($OSComboBox.SelectedItem -match "Windows 10 1*") {
	...
	$richtextbox2_Click={
		Start-Process -Path "https://paypal.me/modaly"
...
wAAAAP/////////////////////////////////////AAAAA')
	...
	$MainForm.Text = 'Driver Automation Tool: Version 6.1.1'
...
AAALDwAACw8BkvkDpQAABQ5JREFUaEPd2VeonEUUwPE0ExPTNMUHsYKgSCxgjcECCpZIYhILqFGs
...
W/MmV9clXL8AAAAASUVORK5CYII=')
	...
	$MicrosoftCheckBox.Location = '18, 111'
...
AAALDQAACw0B7QfALAAABXpJREFUeF7t3EvoVVUUBvB/mhpJKGX0xMqBOCjQaBBWQjiIhEKM3g/M
...
5e4AAAAASUVORK5CYII=')
	...
	$ConifgSiteInstruction.Location = '9, 27'
	$ConifgSiteInstruction.Multiline = $True
	$ConifgSiteInstruction.Name = 'ConifgSiteInstruction'
	$ConifgSiteInstruction.ReadOnly = $True
	$ConifgSiteInstruction.Size = '539, 58'
	$ConifgSiteInstruction.TabIndex = 103
	$ConifgSiteInstruction.TabStop = $False
	$ConifgSiteInstruction.Text = 'Please specify the primary site server and click on the Connect To ConfigMgr button to establish connectivity to your ConfigMgr environment'
	#
	...
	$CleanSourceText.Location = '37, 179'
	...
	$RemoveSuperText.Location = '37, 117'
	...
	$RemoveLegacyDriverCheckbox.Location = '26, 94'
	...
	$RemoveDriverSourceCheckbox.Location = '26, 152'
...

...
iVBORw0KGgoAAAANSUhEUgAAAGQAAABkCAYAAABw4pVUAAAABGdBTUEAALGPC/xhBQAAAAlwSFlz
AAALDgAACw4BQL7hQQAAAvtJREFUeF7t3K1uVFEUxfEhiIqK0gSDQfAAFEmCwyAwBIUiGAwtkBCC
...
iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAABGdBTUEAALGPC/xhBQAAAAlwSFlz
AAALDwAACw8BkvkDpQAAAbBJREFUaEPt1jFKBEEUBNDVxBUDMTHfi6jgJcyMPISBxp7ExFQRQREW
...
iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAABGdBTUEAALGPC/xhBQAAAAlwSFlz
AAALDwAACw8BkvkDpQAAAt1JREFUaEPt2U+IjWEUx/H5F0rN1gIpFpOyoJSGhewmEqWkbKRmI7ES
...
iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAABGdBTUEAALGPC/xhBQAAAAlwSFlz
AAALDwAACw8BkvkDpQAAAlVJREFUaEPt2b1rFFEUBfCNX0E0CUY7FQutopBAKsEiBPwDxE5sBO1U
...
RU5ErkJggg==')
	...
	#
	$ModelProgressOverlay.Anchor = 'Bottom, Left, Right'
	...
	# ModelProgressLabel
	#
	$ModelProgressLabel.Anchor = 'Bottom, Left'
	...
	# AboutPanelRight
	#
	$AboutPanelRight.Controls.Add($ReleaseNotesLabel)
	$AboutPanelRight.Controls.Add($richtextbox3)
	$AboutPanelRight.Controls.Add($NewVersion)
	$AboutPanelRight.Controls.Add($MSTechnetSiteLaunchButton)
	$AboutPanelRight.Controls.Add($NewVersionLabel)
	...
	$ReleaseNotesLabel.Font = 'Verdana, 10pt'
	$ReleaseNotesLabel.ForeColor = 'Black'
	$ReleaseNotesLabel.Location = '35, 97'
	$ReleaseNotesLabel.Name = 'ReleaseNotesLabel'
	$ReleaseNotesLabel.Size = '102, 21'
	$ReleaseNotesLabel.TabIndex = 38
	$ReleaseNotesLabel.Text = 'Release Notes'
	$ReleaseNotesLabel.UseCompatibleTextRendering = $True
	$ReleaseNotesLabel.Visible = $False
	#
	# richtextbox3
	#
	...
	$NewVersionLabel.Location = '35, 65'
	...
	# ReleaseNotesText
	#
	$ReleaseNotesText.BackColor = 'White'
...
iVBORw0KGgoAAAANSUhEUgAAAGQAAABkCAYAAABw4pVUAAAABGdBTUEAALGPC/xhBQAAAAlwSFlz
AAALDgAACw4BQL7hQQAAChVJREFUeF7tnVvIdkUVxz+0/EyzxE5U4BFLjaIkS4wCRSEC0yKISLz7
...
0g4rXGmHFa60wwpX2mGFK+2wwpV2WOFKO6xwpRV7B/4LyowiO2CXutoAAAAASUVORK5CYII=')
	...
	$ModernDriverDesc.Location = '16, 288'
...
'
	...
	$ModernDriverLabel.Location = '14, 255'
...
THIS SCRIPT MUST NOT BE EDITED AND REDISTRIBUTED WITHOUT EXPRESS PERMISSION OF THE AUTHOR.'
	...
	$lBuildDateLabel.Location = '706, 44'
...
#region Source: Globals.ps1
	...
	$ScriptRelease = "6.1.1"
	$ScriptBuildDate = "2018-09-06"
	# 2018-09-07 (oelkufr): Commented the Invoke-WebRequest for new release as it does not work behind a proxy / is run before proxy credentials can be specified            	
	...
	# 2018-09-07 (oelkufr): Changed to $HPSoftPaqListURL
    # $HPSoftPaqList = 'https://ftp.hp.com/pub/softlib/software/sms_catalog/HpCatalogForSms.latest.cab'
    $HPSoftPaqListURL = 'https://ftp.hp.com/pub/softlib/software/sms_catalog/HpCatalogForSms.latest.cab'
	...
	# 2018-09-07 (oelkufr): Changed to use the new $HPSoftPaqListURL variable instead
    # $HPSoftPaqCabFile = [string]($HPSoftPaqList | Split-Path -Leaf)
    $HPSoftPaqCabFile = [string]($HPSoftPaqListURL | Split-Path -Leaf)
	...
	$MicrosoftXMLSource = "https://www.scconfigmgr.com/wp-content/uploads/xml/downloadlinks.xml"
	...
	function UpdateModeList {
		...
		if ($HPCheckBox.Checked -eq $true) {
			...
			if ((Test-Path -Path $global:TempDirectory\$HPSoftPaqXMLFile) -eq $false) {
				try {
					...
					if ((Test-Path -Path $global:TempDirectory\$HPSoftPaqCabFile) -eq $false) {
						...
						# Download HP Model Cabinet File
                        # 2018-09-07 (oelkufr): Changed to use new $HPSoftPaqListURL variable instead
						# global:Write-CMLogEntry -Value "Info: Downloading HP softpaq cabinet file from $HPSoftPaqList" -Severity 1
                        global:Write-CMLogEntry -Value "Info: Downloading HP softpaq cabinet file from $HPSoftPaqListURL" -Severity 1
						if ($global:ProxySettingsSet -eq $true) {
							# 2018-09-07 (oelkufr): Changed to use new $HPSoftPaqListURL variable instead
                            # Start-BitsTransfer -Source $HPSoftPaqList -Destination $global:TempDirectory @global:BitsProxyOptions
                            Start-BitsTransfer -Source $HPSoftPaqListURL -Destination $global:TempDirectory @global:BitsProxyOptions
						}
						else {
							# 2018-09-07 (oelkufr): Changed to use new $HPSoftPaqListURL variable instead
                            # Start-BitsTransfer -Source $HPSoftPaqList -Destination $global:TempDirectory @global:BitsOptions
                            Start-BitsTransfer -Source $HPSoftPaqListURL -Destination $global:TempDirectory @global:BitsOptions
						}
					}
					# Expand Cabinet File
					global:Write-CMLogEntry -Value "Info: Expanding HP softpaq cabinet file: $HPSoftPaqCabFile" -Severity 1
					# 2018-09-10 (oelkufr): Added an addtional "\" to the target directory "$global:TempDirectory\\"
                    Expand "$global:TempDirectory\$HPSoftPaqCabFile" -F:"*.XML" "$global:TempDirectory\\"
			...
			if (($global:HPSoftPaqXML -eq $null) -and ((Test-Path -Path $global:TempDirectory\$HPSoftPaqXMLFile) -eq $true)) {
				try {
	...
	function HPBiosFinder {
		...
		global:Write-CMLogEntry -Value "Info: Checking for existing HP cabinet file" -Severity 1
		if ((Test-Path -Path $global:TempDirectory\$HPPlatformCabFile) -eq $false) {
			try {
				Set-Location -Path $global:TempDirectory
				...
				# Expand Cabinet File
				global:Write-CMLogEntry -Value "Info: Expanding HP driver pack cabinet file: $HPXMLFile" -Severity 1
				Expand "$global:TempDirectory\$HPPlatformCabFile" -F:* "$global:TempDirectory\$HPPlatformXMLFile"
			}
			catch {
				ErrorOutput -Message "Error: $($_.Exception.Message)" -Severity 3
			}
		...
		if ($global:HPPlatformXML -ne $null) {
			...
			if ($HPSystemSKU -ne $null) {
				...
				if ($HPDownloadError -ne $true) {
					...
					if ((Test-Path -Path $global:TempDirectory\$HPCabFile) -eq $true) {
						# Expand Cabinet File
	...
	function Read-XMLSettings {
		...
		try {
			...
			if ($global:DATSettingsXML.Settings.Manufacturer.Lenovo -eq "True") {
				$LenovoCheckBox.Checked = $true
			}
			...
			foreach ($Model in $ImportModels) {
				...
				if ($Make -eq "Lenovo") {
					...
					if ($global:LenovoModelDrivers -ne $null) {
                        # 2018-09-07 (oelkufr):
                        if ($global:ProxySettingsSet -eq $true) {
						    [xml]$global:LenovoModelXML = (New-Object System.Net.WebClient -Property @{Proxy = $global:ProxyServer}).DownloadString("$LenovoXMLSource")
					    } else {
				...
				if ($Make -eq "Microsoft") {
                    ...
                    # 2018-09-07 (oelkufr):
                    if ($global:ProxySettingsSet -eq $true) {
						[xml]$MicrosoftModelXML = (New-Object System.Net.WebClient -Property @{Proxy = $global:ProxyServer}).DownloadString("$MicrosoftXMLSource")
					} else {
											...
											if ($ImportInto -like "*Driver*") {
												if ((Get-ChildItem -Recurse -Path "$DriverExtractDest" -Filter *.inf -File).count -ne 0) {
													...
													if ($DriverINFFiles.Count -ne $null) {
														...
														global:Write-CMLogEntry -Value "$($Product): Checking driver package created successfully" -Severity 1
				...
				if ($RemoveLegacyDriverCheckbox.Checked -eq $true) {
					...
					$ModelPackages = Get-CMPackage -Name "*$Model*$WindowsVersion*$Architecture*" | Select-Object Name, PackageID, SourceDate | Sort-Object SourceDate -Descending
					if ($ModelPackages.Count -gt "1") {
						$LegacyPackage = $ModelPackages | Select-Object -Last 1
						global:Write-CMLogEntry -Value "$($Product): Removing $($LegacyPackage.Name) / Package ID $($LegacyPackage.PackageID)" -Severity 1
	...
	function ValidateProxyAccess {
        param (
            # 2018-09-10 (oelkufr): Changed all [String[]][ValidateNotNullOrEmpty()] = [String][ValidateNotNullOrEmpty()]
			[parameter(Mandatory = $true)]
			[String][ValidateNotNullOrEmpty()]
			# 2018-09-07 (oelkufr): Renamed $ProxyServer param to $ProxyServerURL
            # [String]$ProxyServer,
		...
		# 2018-09-07 (oelkufr): Using renamed $ProxyServerURL variable instead
        # $Proxy = New-Object System.Net.WebProxy($ProxyServer)
        # $Proxy = New-Object System.Net.WebProxy($ProxyServerURL)
		$SecurePassword = $Password | ConvertTo-SecureString -AsPlainText -Force
		# 2018-09-07 (oelkufr): Added $globa:$ProxyServerURL to make the variable available globally
        $global:ProxyServerURL = $ProxyServerURL
        $global:ProxyCredentials = New-Object System.Management.Automation.PSCredential $Username, $SecurePassword
		$global:ProxyServer = New-Object System.Net.WebProxy($ProxyServerURL)
		$global:ProxyServer.Credentials = $global:ProxyCredentials
        # 2010-09-10 (oelkufr): Added a $BitsProxy variable
        [String]$BitsProxy = "$(([Uri]$ProxyServerURL).Host):$(([Uri]$ProxyServerURL).Port)"
		...
		Try {
			...
			$global:InvokeProxyOptions = @{
                ...
                'Proxy'					       = "$global:ProxyServerURL";
				# 2018-09-07 (oelkufr): Commented ProxyUseDefaultCredentials to actually use specified credentials
			...
			$global:BitsProxyOptions = @{
				'RetryInterval'		      = "60";
				'RetryTimeout'		      = "180";
                # 2018-09-07 (oelkufr): Added a commented hint to a tested alternative
                # 'ProxyList'			      = "<ProxyIP>"; # tested alternative
                'ProxyList'			      = @($BitsProxy); # Using new variable
	...
	function Create-CustomPkg {
		...
		$ConfigMgrPkg = {
			...
			#$OperatingSystem = $OperatingSystem + $WindowsVersion
	...
	function Start-MDTImportProcess {
		...
		foreach ($MDTDeploymentShare in $global:MDTDeploymentShares) {
			...
			if ($MDTDriverStructureCombo.SelectedIndex -eq 0) {
				...
				if ((Test-Path $MDTDriverPath\$OperatingSystemDir\$Make\$Model\$DriverRevision) -eq $false) {
					...
					global:Write-CMLogEntry -Value "$($Product): MDT Driver Path = $MDTDriverPath\$OperatingSystemDir\$Make\$Model\$DriverRevision" -Severity 1
					try {
						# =============== MDT Driver Import ====================				
						if ($Make -match "Dell") {
					...
					global:Write-CMLogEntry -Value "$($Product): Driver pack already exists." -Severity 2
				}
			}
			if ($MDTDriverStructureCombo.SelectedIndex -eq 1) {
				...
				if ((Test-Path $MDTDriverPath\$Make\$Model\$OperatingSystemDir\$DriverRevision) -eq $false) {
					New-Item -path $MDTDriverPath\$Make\$Model\$OperatingSystemDir -enable "True" -Name $DriverRevision -ItemType Directory
					global:Write-CMLogEntry -Value "$($Product): Importing MDT driver pack for $Make $Model - Revision $DriverRevision" -Severity 1
					global:Write-CMLogEntry -Value "$($Product): MDT Driver Path = $MDTDriverPath\$Make\$Model\$OperatingSystemDir\$DriverRevision" -Severity 1
					# =============== MDT Driver Import ====================				
					if ($Make -match "Dell") {
						$DriverFolder = (Get-ChildItem -Path "$DriverExtractDest" -Recurse -Directory | Where-Object {
								$_.Name -eq "$Architecture"
						...
						global:Write-CMLogEntry -Value "$($Product): Importing MDT drivers from $DriverExtractDest. This might take several minutes." -Severity 1
						Import-MDTDriver -path "$MDTDriverPath\$Make\$Model\$OperatingSystemDir\$DriverRevision" -SourcePath "$DriverExtractDest"
					}
					else {
						global:Write-CMLogEntry -Value "$($Product): Importing MDT drivers from $DriverExtractDest. This might take several minutes." -Severity 1
						Import-MDTDriver -path "$MDTDriverPath\$Make\$Model\$OperatingSystemDir\$DriverRevision" -SourcePath "$DriverExtractDest"
					}
					global:Write-CMLogEntry -Value "$($Product): MDT driver import process completed for $Make $Model." -Severity 1
				}
				else {
					global:Write-CMLogEntry -Value "$($Product): Driver pack already exists." -Severity 2
				}
